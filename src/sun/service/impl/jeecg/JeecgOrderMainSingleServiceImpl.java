...
public class JeecgOrderMainSingleServiceImpl extends BaseServiceImpl implements JeecgOrderMainSingleServiceI {
	...
	private BaseDaoI<JeecgOrderMainSingleEntity> jeecgOrderMainSingleEntityDao;
	@Autowired
	private BaseDaoI<JeecgOrderCustomSingleEntity> jeecgOrderCustomSingleEntityDao;
	@Autowired
	private BaseDaoI<JeecgOrderProductSingleEntity> jeecgOrderProductSingleEntityDao;
	public BaseDaoI<JeecgOrderMainSingleEntity> getJeecgOrderMainSingleEntityDao() {
		return jeecgOrderMainSingleEntityDao;
	}
	@Autowired
	public void setJeecgOrderMainSingleEntityDao(BaseDaoI<JeecgOrderMainSingleEntity> jeecgOrderMainSingleEntityDao) {
	...
	private String addWhere(JeecgOrderMainSinglePage jeecgOrderMainSinglePage, String hql, List<Object> values) {
		...
		SearchSqlGenerateUtil.createSearchParamsHql(hqlbf, values, jeecgOrderMainSingleEntity);
		hql = hqlbf.toString();
		//-----------------------------------------------------
	...
	public void editMain(JeecgOrderMainSinglePage jeecgOrderMainSinglePage,List<JeecgOrderCustomSinglePage> jeecgOrderCustomSingleList,List<JeecgOrderProductSinglePage> jeecgOrderProductSingleList)  throws Exception{
	    ...
	    if(t != null) {
			MyBeanUtils.copyBeanNotNull2Bean(jeecgOrderMainSinglePage, t);
		}
		...
		for(JeecgOrderCustomSinglePage page:jeecgOrderCustomSingleList){
			...
			MyBeanUtils.copyBeanNotNull2Bean(page, jeecgOrderCustomSingleEntity);
			...
			SearchSqlGenerateUtil.setUpdateMessage(jeecgOrderCustomSingleEntity);
		...
		for(JeecgOrderProductSinglePage page:jeecgOrderProductSingleList){
			...
			MyBeanUtils.copyBeanNotNull2Bean(page, jeecgOrderProductSingleEntity);
			...
			SearchSqlGenerateUtil.setUpdateMessage(jeecgOrderProductSingleEntity);
