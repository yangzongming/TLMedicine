...
import sun.service.jeecg.JeecgOrderProductSingleServiceI;
...
public class JeecgOrderProductSingleServiceImpl extends BaseServiceImpl implements JeecgOrderProductSingleServiceI {
	...
	public BaseDaoI<JeecgOrderProductSingleEntity> getJeecgOrderProductSingleEntityDao() {
		return jeecgOrderProductSingleEntityDao;
	}
	@Autowired
	public void setJeecgOrderProductSingleEntityDao(BaseDaoI<JeecgOrderProductSingleEntity> jeecgOrderProductSingleEntityDao) {
	...
	private String addWhere(JeecgOrderProductSinglePage jeecgOrderProductSinglePage, String hql, List<Object> values) {
		...
		SearchSqlGenerateUtil.createSearchParamsHql(hqlbf, values, jeecgOrderProductSingleEntity);
		hql = hqlbf.toString();
		//-----------------------------------------------------
	...
	public void update(JeecgOrderProductSinglePage jeecgOrderProductSinglePage) throws Exception {
	    ...
	    if(t != null) {
			MyBeanUtils.copyBeanNotNull2Bean(jeecgOrderProductSinglePage, t);
		}
	}
