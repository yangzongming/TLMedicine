...
import sun.service.jeecg.JeecgOrderCustomServiceI;
...
public class JeecgOrderCustomServiceImpl extends BaseServiceImpl implements JeecgOrderCustomServiceI {
	...
	public BaseDaoI<JeecgOrderCustomEntity> getJeecgOrderCustomEntityDao() {
		return jeecgOrderCustomEntityDao;
	}
	@Autowired
	public void setJeecgOrderCustomEntityDao(BaseDaoI<JeecgOrderCustomEntity> jeecgOrderCustomEntityDao) {
	...
	private String addWhere(JeecgOrderCustomPage jeecgOrderCustomPage, String hql, List<Object> values) {
		...
		SearchSqlGenerateUtil.createSearchParamsHql(hqlbf, values, jeecgOrderCustomEntity);
		hql = hqlbf.toString();
		//-----------------------------------------------------
	...
	public void update(JeecgOrderCustomPage jeecgOrderCustomPage) throws Exception {
	    ...
	    if(t != null) {
			MyBeanUtils.copyBeanNotNull2Bean(jeecgOrderCustomPage, t);
		}
	}
