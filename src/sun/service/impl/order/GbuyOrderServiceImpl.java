package sun.service.impl.order;
...
public class GbuyOrderServiceImpl extends BaseServiceImpl implements GbuyOrderServiceI {
	...
	private BaseDaoI<GbuyOrderEntity> gbuyOrderEntityDao;
	@Autowired
	private BaseDaoI<GbuyOrderCustomEntity> gbuyOrderCustomEntityDao;
	@Autowired
	private BaseDaoI<GbuyOrderProductEntity> gbuyOrderProductEntityDao;
	public BaseDaoI<GbuyOrderEntity> getGbuyOrderEntityDao() {
		return gbuyOrderEntityDao;
	}
	@Autowired
	public void setGbuyOrderEntityDao(BaseDaoI<GbuyOrderEntity> gbuyOrderEntityDao) {
	...
	private String addWhere(GbuyOrderPage gbuyOrderPage, String hql, List<Object> values) {
		...
		SearchSqlGenerateUtil.createSearchParamsHql(hqlbf, values, gbuyOrderEntity);
		hql = hqlbf.toString();
		//-----------------------------------------------------
	...
	public void editMain(GbuyOrderPage gbuyOrderPage,List<GbuyOrderCustomPage> gbuyOrderCustomList,List<GbuyOrderProductPage> gbuyOrderProductList)  throws Exception{
	    ...
	    if(t != null) {
			MyBeanUtils.copyBeanNotNull2Bean(gbuyOrderPage, t);
		}
		...
		for(GbuyOrderCustomPage page:gbuyOrderCustomList){
			...
			MyBeanUtils.copyBeanNotNull2Bean(page, gbuyOrderCustomEntity);
			...
			SearchSqlGenerateUtil.setUpdateMessage(gbuyOrderCustomEntity);
		...
		for(GbuyOrderProductPage page:gbuyOrderProductList){
			...
			MyBeanUtils.copyBeanNotNull2Bean(page, gbuyOrderProductEntity);
			...
			SearchSqlGenerateUtil.setUpdateMessage(gbuyOrderProductEntity);
