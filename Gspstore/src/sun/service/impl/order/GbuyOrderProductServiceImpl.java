...
import sun.service.order.GbuyOrderProductServiceI;
...
public class GbuyOrderProductServiceImpl extends BaseServiceImpl implements GbuyOrderProductServiceI {
	...
	public BaseDaoI<GbuyOrderProductEntity> getGbuyOrderProductEntityDao() {
		return gbuyOrderProductEntityDao;
	}
	@Autowired
	public void setGbuyOrderProductEntityDao(BaseDaoI<GbuyOrderProductEntity> gbuyOrderProductEntityDao) {
	...
	private String addWhere(GbuyOrderProductPage gbuyOrderProductPage, String hql, List<Object> values) {
		...
		SearchSqlGenerateUtil.createSearchParamsHql(hqlbf, values, gbuyOrderProductEntity);
		hql = hqlbf.toString();
		//-----------------------------------------------------
	...
	public void update(GbuyOrderProductPage gbuyOrderProductPage) throws Exception {
	    ...
	    if(t != null) {
			MyBeanUtils.copyBeanNotNull2Bean(gbuyOrderProductPage, t);
		}
	}
