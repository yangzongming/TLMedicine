...
import sun.service.order.GbuyOrderCustomServiceI;
...
public class GbuyOrderCustomServiceImpl extends BaseServiceImpl implements GbuyOrderCustomServiceI {
	...
	public BaseDaoI<GbuyOrderCustomEntity> getGbuyOrderCustomEntityDao() {
		return gbuyOrderCustomEntityDao;
	}
	@Autowired
	public void setGbuyOrderCustomEntityDao(BaseDaoI<GbuyOrderCustomEntity> gbuyOrderCustomEntityDao) {
	...
	private String addWhere(GbuyOrderCustomPage gbuyOrderCustomPage, String hql, List<Object> values) {
		...
		SearchSqlGenerateUtil.createSearchParamsHql(hqlbf, values, gbuyOrderCustomEntity);
		hql = hqlbf.toString();
		//-----------------------------------------------------
	...
	public void update(GbuyOrderCustomPage gbuyOrderCustomPage) throws Exception {
	    ...
	    if(t != null) {
			MyBeanUtils.copyBeanNotNull2Bean(gbuyOrderCustomPage, t);
		}
	}
