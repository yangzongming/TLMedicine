...
import sun.service.jeecg.JeecgOrderCustomSingleServiceI;
...
public class JeecgOrderCustomSingleServiceImpl extends BaseServiceImpl implements JeecgOrderCustomSingleServiceI {
	...
	public BaseDaoI<JeecgOrderCustomSingleEntity> getJeecgOrderCustomSingleEntityDao() {
		return jeecgOrderCustomSingleEntityDao;
	}
	@Autowired
	public void setJeecgOrderCustomSingleEntityDao(BaseDaoI<JeecgOrderCustomSingleEntity> jeecgOrderCustomSingleEntityDao) {
	...
	private String addWhere(JeecgOrderCustomSinglePage jeecgOrderCustomSinglePage, String hql, List<Object> values) {
		...
		SearchSqlGenerateUtil.createSearchParamsHql(hqlbf, values, jeecgOrderCustomSingleEntity);
		hql = hqlbf.toString();
		//-----------------------------------------------------
	...
	public void update(JeecgOrderCustomSinglePage jeecgOrderCustomSinglePage) throws Exception {
	    ...
	    if(t != null) {
			MyBeanUtils.copyBeanNotNull2Bean(jeecgOrderCustomSinglePage, t);
		}
	}
