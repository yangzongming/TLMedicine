...
<link rel="stylesheet" href="<%=basePath%>/main/css/tablelock.css"
	mce_href="tablelock.css" />
<script type="text/javascript" language="javascript"
	src="<%=basePath%>/main/js/tablelock.js"></script>
<script type="text/javascript" charset="utf-8">
	...
	$(document).ready(
			function() {
				...
				//销售单明细追加
				$("#button_add_saleDetail").bind(
						"click",
						function() {
							var tr = $("#add_saleDetail_table_template tr")
									.clone();
							var keyid = sy.UUID();
							tr.attr("id", keyid);
							$("#add_saleDetail_table").append(tr);
							var articlename = tr.find(
									"select[name*='.articlename']").eq(0);
							articlename.attr("class", "easyui-combobox");
							var saleprice = tr
									.find("input[name*='.saleprice']").eq(0);
				...
				//销售单明细删除
				$("#button_del_saleDetail").bind(
						"click",
						function() {
							$("#add_saleDetail_table").find("input:checked")
				...
				myForm = $('#myForm').form(
						{
							...
							success : function(data) {
								...
								if (json && json.success) {
									...
									window.parent.window.datagrid
											.datagrid('reload');
									window.parent.window.messageshow('成功',
											json.msg);
								} else {
									window.parent.window.messageshow('失败',
											'操作失败!' + json.msg);
								}
							}
						});
				$(window.parent.document.getElementById("loading")).fadeOut(
						"slow", function() {
											...
											function() {
												...
												if (numberboxname != null) {
													if (numberboxname
														...
														var e = numberboxname
																.indexOf("]");
														var new_numberboxname = numberboxname
																.substring(
																		s + 1,
																		e);
														$this
	...
	function dosubmit() {
		if ($('#myForm').form('validate')) {
			if (checkStockAgain()) {
				...
				$.messager.confirm('请确认', '总计金额：' + totalamount + '，您确定提交吗？',
						function(r) {
							if (r) {
								$.messager.progress({
									text : '数据保存中....',
	...
	function checkStockAgain() {
		...
		for (var i = 0; i < rows.length; i++) {
			...
			var saleprice = $("input[id*='.saleprice']", rows[i]).numberbox(
					"getValue");
			totalamount += parseInt(num, 10) * parseFloat(saleprice, 10);
			var articlename = $("select[id*='.articlename']", rows[i])
					.combobox("getText");
			if (stockkeyinfo.indexOf(corrent) != -1) {
				var againinf = "第" + (i + 1) + "行[" + articlename
						+ "]与前面的存在重复!";
	...
	function computeAmount(obj) {
		var num = $(obj).parent().prev().find("input[id*='.num']").eq(0)
				.numberbox("getValue");
		;
		var saleprice = $(obj).parent().prev().prev().find(
				"input[id*='.saleprice']").eq(0).numberbox("getValue");
		if (num != null && num != "" && saleprice != null && saleprice != "")
			$(obj).val(parseInt(num, 10) * parseFloat(saleprice, 10));
	}

	function findLastInprice(obj) {
		var articleid = $(obj).parent().parent().find(
				"input[name*='.articleid']").eq(0).val();
		var salepriceinput = $(obj).parent().parent().find(
				"input[id*='.saleprice']").eq(0);
		...
		$.ajax({
			...
			success : function(response) {
				if (response.flag == 1) {
					$.messager
							.alert('提示',
									"该客户上次购买[" + response.articlename
											+ "]<br>价格是：[" + response.saleprice
											+ "]元！", 'info');
...
<body>
	<div id="chk_idAll">
		<form name="myForm" id="myForm" method="post">
			<div>
				<table width="998px">
					...
					<tr>
						...
						<td align="left"><select id="customerid" name="customerid"
						...
						<td align="left"><input name="saledate" type="text"
							style="width: 135px;" class="easyui-datetimebox" maxlength=""
							data-options="required:true" /></td>
						<td align="left">业务员</td>
						<td align="left"><select id="accountid" name="accountid"
							type="text" class="easyui-combobox"
							data-options="required:true,
						...
						<td align="left"><input id="salerate" readonly="readonly"
							style="width: 70px;" name="salerate" type="text"
							class="easyui-validatebox" maxlength=""
							data-options="required:true" /></td>
						<td align="left">备注</td>
						<td align="left"><input style="width: 230px;" name="meno"
							type="text" class="easyui-validatebox" maxlength="100"
							data-options="" /></td>
					</tr>
					<tr>
					...
					<table>
						<tr bgcolor="#CCE6D1">
							<td align="left"><strong>&nbsp;&nbsp;销售单明细&nbsp;&nbsp;</strong>
								<input type="button" id="button_add_saleDetail" class=" wd1 btn"
								value="添加" /> <input type="button" id="button_del_saleDetail"
								class=" wd1 btn" value="删除" /></td>
						</tr>
							...
							<td align="left">
								<table border="0" cellpadding="2" cellspacing="0"
									...
									<tbody id="add_saleDetail_table">
										<tr>
											<td align="center"><input type="checkbox" name="ck" /> <input
												type="hidden" name="saleDetailList[0].stockkey" /> <input
												type="hidden" name="saleDetailList[0].articleid" /></td>
											<td align="left"><select
												id="stockinDetailList[0].articlename"
												name="stockinDetailList[0].articlename" type="text"
		 						       ...
		 						       "
											...
											<td align="left"><input name="factory"
												readonly="readonly" maxlength="20" type="text"
												class="easyui-validatebox" style="width: 70px;"></td>
											<td align="left"><input name="articlespec"
												readonly="readonly" maxlength="20" type="text"
												class="easyui-validatebox" style="width: 50px;"></td>
											<td align="left"><input name="unitname"
												readonly="readonly" maxlength="20" type="text"
												class="easyui-validatebox" style="width: 30px;"></td>
											<td align="left"><input name="serial"
												readonly="readonly" maxlength="20" type="text"
												class="easyui-validatebox" style="width: 70px;"></td>
											<td align="left"><input name="expiredate"
												readonly="readonly" maxlength="20" type="text"
												class="easyui-validatebox" style="width: 65px;"></td>
											<td align="left"><input name="retailprice"
												readonly="readonly" maxlength="20" type="text"
												class="easyui-validatebox" style="width: 60px;"></td>
											<td align="left"><input name="depotname"
												readonly="readonly" maxlength="20" type="text"
												class="easyui-validatebox" style="width: 50px;"></td>
											<td align="left"><input name="stocknum"
												readonly="readonly" maxlength="20" type="text"
												class="easyui-validatebox" style="width: 50px;"></td>
											<td align="left"><input id="saleDetailList[0].saleprice"
												name="saleDetailList[0].saleprice" maxlength="" type="text"
												data-options="required:true,precision:2"
												class="easyui-numberbox" style="width: 50px;"></td>
											<td align="left"><input id="saleDetailList[0].num"
												name="saleDetailList[0].num" maxlength="" type="text"
												class="easyui-numberbox"
												data-options="required:true,precision:0,min:0"
												style="width: 50px;"></td>
											<td align="left"><input name="saleDetailList[0].amount"
												onclick="computeAmount(this)" readonly="readonly"
												maxlength="" type="text" data-options="precision:2"
												style="width: 50px;"></td>
											<td align="left"><input
												name="saleDetailList[0].secretno" maxlength="50" type="text"
												class="easyui-validatebox" data-options="required:true"
												style="width: 50px;"></td>
											<td align="left"><span class="calendar-menu-next"
												onclick="findLastInprice(this)" style="width: 16px;"></span>
											</td>
										</tr>
									</tbody>
								</table>
			...
			<div align="center">
				<table width="100%;">
					<tr>
						<td height="50" colspan="8" align="center"><input
							value=" 关 闭 " type="button" id="doReturn" /> <input value=" 提 交 "
							type="button" onClick="dosubmit();" /></td>
					</tr>
					<tr>
						<td style="font-size: 12px; color: blue; text-align: left;">
							注:行中的黑色箭头作用是根据当前的客户和当前行的品种查找客户最近一次的销售价格;</td>
					</tr>
				</table>
			</div>
		</form>
	...
	<table style="display: none">
		<tbody id="add_saleDetail_table_template">
			<tr>
				<td align="center"><input type="checkbox" name="ck" /> <input
					type="hidden" name="saleDetailList[#index#].stockkey" /> <input
					type="hidden" name="saleDetailList[0].articleid" /></td>
				<td align="left"><select
					id="stockinDetailList[#index#].articlename"
					name="stockinDetailList[#index#].articlename" type="text"
					data-options="required:true,
		 						         url:'saleAction!saleStockCombox.action',
								      	valueField:'stockkey',
								        textField:'articlename',
				...
				<td align="left"><input name="factory" readonly="readonly"
					maxlength="20" type="text" class="easyui-validatebox"
					style="width: 70px;"></td>
				<td align="left"><input name="articlespec" readonly="readonly"
					maxlength="20" type="text" class="easyui-validatebox"
					style="width: 50px;"></td>
				<td align="left"><input name="unitname" readonly="readonly"
					maxlength="20" type="text" class="easyui-validatebox"
					style="width: 30px;"></td>
				<td align="left"><input name="serial" readonly="readonly"
					maxlength="20" type="text" class="easyui-validatebox"
					style="width: 70px;"></td>
				<td align="left"><input name="expiredate" readonly="readonly"
					maxlength="20" type="text" class="easyui-validatebox"
					style="width: 65px;"></td>
				<td align="left"><input name="retailprice" readonly="readonly"
					maxlength="20" type="text" class="easyui-validatebox"
					style="width: 60px;"></td>
				<td align="left"><input name="depotname" readonly="readonly"
					maxlength="20" type="text" class="easyui-validatebox"
					style="width: 50px;"></td>
				<td align="left"><input name="stocknum" readonly="readonly"
					maxlength="20" type="text" class="easyui-validatebox"
					style="width: 50px;"></td>
				<td align="left"><input id="saleDetailList[#index#].saleprice"
					name="saleDetailList[#index#].saleprice" maxlength="" type="text"
					data-options="required:true,precision:2" style="width: 50px;">
				</td>
				<td align="left"><input id="saleDetailList[#index#].num"
					name="saleDetailList[#index#].num" maxlength="" type="text"
					data-options="required:true,precision:0,min:0" style="width: 50px;">
				</td>
				<td align="left"><input name="saleDetailList[#index#].amount"
					onclick="computeAmount(this)" readonly="readonly" maxlength=""
					type="text" data-options="precision:2" style="width: 50px;">
				</td>
				<td align="left"><input name="saleDetailList[#index#].secretno"
					maxlength="50" type="text" class="easyui-validatebox"
					data-options="required:true" style="width: 50px;"></td>
				<td><span class="calendar-menu-next"
					onclick="findLastInprice(this)" style="width: 16px;"></span></td>
			</tr>
		</tbody>
	</table>
</body>
